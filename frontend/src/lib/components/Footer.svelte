...
<footer class="bg-gray-950 border-t border-gray-800 pt-16 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div class="space-y-6">
                <a href="{base}/" class="flex items-center gap-2.5 hover:opacity-80 transition-opacity w-fit">
                    ...
                    <span class="font-display font-bold text-lg md:text-xl text-white">
                        Sahabat<span class="text-blue-400">Anak</span>
                    </span>
                </a>
                <p class="text-gray-400 text-sm leading-relaxed">
                    Yayasan nirlaba yang berfokus pada kesejahteraan dan pendidikan anak-anak marjinal di Indonesia sejak 2025.
                </p>
                <div class="flex gap-4">
                    <a href="/" aria-label="Facebook" class="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
                        </svg>
                    </a>
                    <a href="/" aria-label="Instagram" class="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/" aria-label="Twitter" class="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-gray-400 hover:bg-blue-400 hover:text-white hover:border-blue-400 transition-colors">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Contact -->
            <div>
                <h3 class="font-bold text-white mb-6">Kontak</h3>
                <ul class="space-y-4 text-sm text-gray-400">
                    <li class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-primary text-lg">location_on</span>
                        <span>Jl. Sahabat No. 12, Subang, 12345</span>
                    </li>
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <span>halo@sahabatanak.org</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
            <p>© 2025 Sahabat Anak. All rights reserved.</p>
