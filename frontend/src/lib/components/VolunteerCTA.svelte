...
<section class="w-full bg-gray-100 py-12 sm:py-14 md:py-16 lg:py-24">
  <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
    <div class="size-14 sm:size-16 bg-blue-200 rounded-full flex items-center justify-center mx-auto mb-5 sm:mb-6 text-blue-400">
      <span class="material-symbols-outlined text-3xl sm:text-4xl">handshake</span>
    </div>
    
    <h2 class="text-[#111518] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black tracking-tight mb-3 sm:mb-4">
      Ingin terlibat langsung?
    </h2>
    
    <p class="text-[#637588] text-sm sm:text-base md:text-lg mb-6 sm:mb-7 md:mb-8 max-w-2xl mx-auto">
      Mari berkontribusi tenaga dan waktu Anda sebagai relawan untuk masa depan anak-anak yang lebih cerah.
    </p>
